...
Release target: `1.5.1 "Chemistry Tool"`
...
Expected output: `dist/release/PeriodicTableApp-1.5.1-chemistry-tool-win.zip`.
...
- macOS: `dist/release/PeriodicTableApp-1.5.1-chemistry-tool-mac.zip` (contains `PeriodicTableApp.app`, unsigned)
- Linux: `dist/release/PeriodicTableApp-1.5.1-chemistry-tool-linux.zip`
