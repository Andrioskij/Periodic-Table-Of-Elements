...
Release target: `1.4.3 "Chemistry Tool"`
...
Expected output: `dist/release/PeriodicTableApp-1.4.3-chemistry-tool-win.zip`.
...
- macOS: `dist/release/PeriodicTableApp-1.4.3-chemistry-tool-mac.zip` (contains `PeriodicTableApp.app`, unsigned)
- Linux: `dist/release/PeriodicTableApp-1.4.3-chemistry-tool-linux.zip`
