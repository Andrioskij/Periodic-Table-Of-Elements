...
def build_main_window_texts(translate, trend_button_specs):
    ...
    return {
        ...
        "builder_search_placeholder_a": translate("builder_search_placeholder_a"),
        "builder_search_placeholder_b": translate("builder_search_placeholder_b"),
